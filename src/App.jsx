    ...
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-800'}`}>
      ...
      <header className={`sticky top-0 z-50 backdrop-blur-md border-b ${darkMode ? 'bg-slate-950/80 border-slate-800' : 'bg-white/80 border-slate-200'} transition-all`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-rose-500 via-pink-500 to-violet-600 flex items-center justify-center text-white font-extrabold tracking-wider text-xl shadow-lg animate-gradient">
              LN
            </div>
            <div>
              <span className="font-bold text-lg tracking-tight block">Laiba Nadeem</span>
              <span className="text-xs text-rose-500 font-semibold block -mt-1">Web Developer Portfolio</span>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
            ...
            <a href="#bot" className="hover:text-rose-400 transition-colors">AI Assistant</a>
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className={`p-2 rounded-xl border ${darkMode ? 'bg-slate-900 border-slate-800 hover:bg-slate-800 text-rose-400' : 'bg-slate-100 border-slate-200 hover:bg-slate-200 text-slate-700'} transition-all`}
            ...
            <a 
              href="#contact" 
              className="bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 hover:from-rose-600 hover:to-violet-700 text-white font-semibold text-sm py-2 px-4 rounded-xl shadow-md transition-all flex items-center gap-1"
            >
      ...
      <section className="relative overflow-hidden pt-12 pb-24 px-4 sm:px-6">
        <div className="absolute inset-0 z-0 opacity-30 pointer-events-none">
          <div className="absolute top-10 left-10 w-72 h-72 bg-rose-500/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-violet-500/20 rounded-full blur-3xl"></div>
        </div>

        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold tracking-wide bg-rose-500/10 text-rose-400 border border-rose-500/20">
              <Sparkles size={12} /> Available for Remote & On-Site Roles
            </div>
            <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight">
              Hi, I'm <span className="bg-gradient-to-r from-rose-400 via-pink-400 to-violet-500 bg-clip-text text-transparent">{personalInfo.name}</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0 pt-2">
              <div className={`p-3 rounded-2xl border ${darkMode ? 'bg-slate-900/50 border-slate-800' : 'bg-white border-slate-200'} text-center`}>
                <span className="text-2xl font-black text-rose-500 block">10+</span>
                <span className="text-xs text-slate-400 uppercase font-bold">Live Projects</span>
              </div>
              <div className={`p-3 rounded-2xl border ${darkMode ? 'bg-slate-900/50 border-slate-800' : 'bg-white border-slate-200'} text-center`}>
                <span className="text-2xl font-black text-violet-500 block">11+</span>
                <span className="text-xs text-slate-400 uppercase font-bold">Skills Mastered</span>
              </div>
              <div className={`p-3 rounded-2xl border ${darkMode ? 'bg-slate-900/50 border-slate-800' : 'bg-white border-slate-200'} text-center`}>
                <span className="text-2xl font-black text-pink-500 block">100%</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <a 
                href="#projects" 
                className="bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 hover:from-rose-600 hover:to-violet-700 text-white font-semibold py-3 px-6 rounded-2xl shadow-lg transition-all text-center flex items-center justify-center gap-2"
              >
          ...
          {/* Interactive Info Card - Styled as a Premium ID card with customized warm sunset look */}
          <div className="lg:col-span-5">
            <div className={`p-6 sm:p-8 rounded-3xl border shadow-2xl relative overflow-hidden transition-all ${darkMode ? 'bg-slate-900/70 border-rose-500/20 shadow-rose-500/5' : 'bg-white border-rose-100 shadow-rose-100/40'}`}>
              <div className="absolute top-0 right-0 h-24 w-24 bg-rose-500/10 rounded-bl-full pointer-events-none animate-pulse"></div>
              
              <div className="flex items-center gap-4 mb-6">
                <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-rose-500 via-pink-500 to-violet-600 flex items-center justify-center text-white text-2xl font-bold shadow-md shadow-pink-500/25">
                  LN
                </div>
                <div>
                  <h3 className="font-bold text-lg">{personalInfo.name}</h3>
                  <p className="text-xs text-rose-500 font-semibold">{personalInfo.title}</p>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
                <span className="flex items-center gap-1"><Award size={12} className="text-rose-500" /> Corvit Verified</span>
      ...
      <section id="about" className={`py-20 px-4 sm:px-6 border-t ${darkMode ? 'bg-slate-900/40 border-slate-900' : 'bg-slate-100 border-slate-200'}`}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-2">
            ...
            <div className="h-1.5 w-16 bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 rounded-full mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-stretch">
            <div className={`md:col-span-7 p-6 sm:p-8 rounded-3xl border flex flex-col justify-between ${darkMode ? 'bg-slate-950/80 border-slate-800' : 'bg-white border-slate-200'}`}>
              <div className="space-y-4">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-rose-500/10 text-rose-400">
              ...
              <div className="grid grid-cols-2 gap-4 mt-8 pt-6 border-t border-slate-800">
                <div>
                  <h4 className="font-bold text-rose-400 text-sm">Design Focus</h4>
                  <p className="text-xs text-slate-400 mt-1">Responsive layouts, elegant animations, clean layouts.</p>
                </div>
                <div>
                  <h4 className="font-bold text-violet-400 text-sm">Technical Philosophy</h4>
            ...
            <div className="md:col-span-5 flex flex-col gap-6">
              ...
              <div className={`p-6 rounded-3xl border flex-1 ${darkMode ? 'bg-slate-950/80 border-slate-800' : 'bg-white border-slate-200'}`}>
                <div className="flex items-center gap-2 mb-6">
                  <GraduationCap className="text-rose-400" size={20} />
                  <h3 className="font-black text-lg">Education History</h3>
                </div>

                <div className="space-y-6">
                  {personalInfo.education.map((edu, idx) => (
                    <div key={idx} className="relative pl-5 border-l-2 border-rose-500/30 last:border-0 pb-1">
                      <div className="absolute left-[-5px] top-1 h-2 w-2 rounded-full bg-rose-500"></div>
                      <span className="text-xs font-semibold text-rose-500 block">{edu.duration}</span>
            ...
            {['all', 'frontend', 'design', 'tools'].map((tab) => (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs sm:text-sm font-semibold capitalize transition-all ${
                  activeTab === tab 
                    ? 'bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 text-white shadow-md shadow-pink-500/20' 
                    : darkMode 
            ...
            {filteredSkills.map((skill, index) => (
              ...
              >
                <div className="flex justify-between items-center mb-3">
                  <div className="flex items-center gap-2">
                    <div className="h-2 w-2 rounded-full bg-gradient-to-r from-rose-500 to-violet-600"></div>
                    <span className="font-bold text-sm sm:text-base">{skill.name}</span>
                  </div>
                  <span className="text-xs font-semibold text-rose-400 bg-rose-500/10 px-2 py-0.5 rounded-md">{skill.level}%</span>
                </div>
                {/* Custom Progress Bar with Theme Colors */}
                <div className={`h-2 w-full rounded-full overflow-hidden ${darkMode ? 'bg-slate-800' : 'bg-slate-200'}`}>
                  <div 
                    className="h-full bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 rounded-full transition-all duration-1000 ease-out" 
              ...
              >
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 pb-6 border-b border-slate-800/80">
                  <div className="flex items-center gap-4">
                    <div className="h-12 w-12 rounded-2xl bg-gradient-to-tr from-rose-500 via-pink-500 to-violet-600 flex items-center justify-center text-white text-xl font-black shadow-md">
                      C
                    </div>
                    <div>
                      <h3 className="font-black text-lg sm:text-xl">{exp.role}</h3>
                      <p className="text-sm font-semibold text-rose-400">{exp.company}</p>
                    </div>
                  </div>
                  <div className="flex flex-col md:items-end">
                    <span className="text-xs font-bold text-rose-500 bg-rose-500/10 px-3 py-1 rounded-full">{exp.duration}</span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className={`p-6 sm:p-8 rounded-3xl border ${darkMode ? 'bg-slate-900/70 border-slate-800' : 'bg-white border-slate-200'}`}>
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-violet-500/10 text-violet-400 mb-4">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['React.js', 'React Hooks', 'JavaScript', 'Tailwind Grid', 'State Architecture'].map((tech) => (
                      <span key={tech} className="text-xs bg-rose-500/10 text-rose-400 px-2.5 py-1 rounded-lg font-semibold">{tech}</span>
                    ))}
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                  <div>
                    <h4 className="font-black text-lg flex items-center gap-1.5">
                      <Cpu size={18} className="text-rose-400 animate-pulse" /> Playable React Chess SandBox
                    </h4>
                        ...
                        {moveHistory.length === 0 ? (
                          ...
                          moveHistory.map((m, idx) => (
                            <div key={idx} className="flex items-center gap-2 text-slate-300 bg-slate-900/50 p-1.5 rounded-lg border border-slate-800/40">
                              <span className="text-rose-500 font-bold">#{moveHistory.length - idx}</span>
                              <span>{m}</span>
                            </div>
                          ))
                        )}
          ...
          <div className="mt-20">
            <div className="text-center max-w-2xl mx-auto mb-10 space-y-2">
              <span className="text-xs font-bold tracking-widest text-rose-500 uppercase">Interactive Vercel Applications</span>
                ...
                <div 
                  ...
                  className={`flex flex-col justify-between p-6 rounded-3xl border transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl ${
                    darkMode 
                      ...
                      : 'bg-white border-slate-200 hover:shadow-pink-500/5'
                  }`}
                >
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-rose-500/10 to-violet-600/10 flex items-center justify-center text-rose-400">
                        <Globe size={18} />
                      </div>
                      <span className="text-[10px] font-bold text-rose-400 bg-rose-500/10 px-2 py-0.5 rounded-full uppercase tracking-wider">
                        {proj.category}
                      </span>
                    </div>
                  ...
                  <div>
                    ...
                    <a 
                      ...
                      className="w-full py-2.5 px-4 rounded-xl text-xs font-semibold bg-rose-500 hover:bg-rose-600 text-white transition-all flex items-center justify-center gap-1.5 shadow-lg shadow-rose-500/10"
                    >
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
            <h2 className="text-3xl font-black tracking-tight flex items-center justify-center gap-2">
              <Cpu className="text-rose-400 animate-pulse" /> Laiba's Assistant Twin
            </h2>
            <div className="h-1.5 w-16 bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 rounded-full mx-auto"></div>
          ...
          <div className={`rounded-3xl border shadow-xl overflow-hidden ${darkMode ? 'bg-slate-950 border-slate-800' : 'bg-white border-slate-200'}`}>
            {/* Bot Header */}
            <div className="bg-gradient-to-r from-rose-500/10 via-pink-500/10 to-violet-600/10 px-6 py-4 border-b border-slate-800/60 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-rose-500 to-violet-600 flex items-center justify-center text-white text-lg font-black shadow-md">
                  🤖
                </div>
                <div>
                  <h4 className="font-bold text-sm">Laiba-Bot v1.0</h4>
                  <p className="text-[10px] text-rose-400 font-medium">Online & Ready to answer queries</p>
                </div>
              </div>
              <span className="px-2 py-0.5 rounded bg-rose-500/10 text-rose-400 font-bold text-[10px]">AI Powered</span>
            </div>
            ...
            <form onSubmit={handleSendMessage} className="p-4 border-t border-slate-800 flex gap-3">
              <input
                ...
                className={`flex-1 px-4 py-2.5 rounded-2xl text-xs sm:text-sm focus:outline-none focus:ring-1 ${
                  darkMode 
                    ? 'bg-slate-900 border border-slate-800 text-slate-100 focus:ring-rose-500' 
                    : 'bg-slate-100 border border-slate-300 text-slate-800 focus:ring-rose-500'
                }`}
              />
              <button 
                type="submit" 
                className="bg-rose-500 hover:bg-rose-600 text-white p-2.5 rounded-2xl transition-all shadow-md flex items-center justify-center shrink-0"
            ...
            <div className="lg:col-span-5 flex flex-col justify-between">
              ...
              <div className="pt-8 flex items-center gap-3">
                <a 
                  ...
                  className={`p-3 rounded-2xl border text-slate-400 hover:text-rose-500 transition-all ${darkMode ? 'bg-slate-900 border-slate-800 hover:bg-slate-800' : 'bg-slate-100 border-slate-200'}`}
              ...
              <div className={`p-6 sm:p-8 rounded-3xl border shadow-xl ${darkMode ? 'bg-slate-900/40 border-slate-800' : 'bg-white border-slate-200'}`}>
                {formSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-2xl text-xs sm:text-sm focus:outline-none focus:ring-1 ${
                            darkMode 
                              ? 'bg-slate-950 border border-slate-800 text-slate-100 focus:ring-rose-500' 
                              : 'bg-slate-100 border border-slate-300 text-slate-800 focus:ring-rose-500'
                          }`}
                        />
                      </div>
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-rose-500 via-pink-500 to-violet-600 hover:from-rose-600 hover:to-violet-700 text-white font-semibold py-3.5 px-6 rounded-2xl shadow-lg transition-all flex items-center justify-center gap-2 text-sm"
                    >
      ...
      <footer className={`py-12 border-t ${darkMode ? 'bg-slate-950 border-slate-900 text-slate-400' : 'bg-slate-100 border-slate-200 text-slate-600'}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-6 text-xs font-semibold">
            ...
            <a href="#projects" className="hover:text-rose-500 transition-colors">Chess Project</a>
